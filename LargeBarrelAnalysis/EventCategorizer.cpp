  ...
  for(unsigned int i=0; i<hits.size(); i++) {
    for(unsigned int j=i+1; j<hits.size(); j++) {
      for(unsigned int k=j+1; k<hits.size(); k++) {
        ...
        // TOT vs Hit along Z
        getStatistics().getHisto2D("TOT_ZHit_1")->Fill(firstHit.getPosZ(), calculateSumOfTOTs(firstHit));
        getStatistics().getHisto2D("TOT_ZHit_2")->Fill(secondHit.getPosZ(), calculateSumOfTOTs(secondHit));
        getStatistics().getHisto2D("TOT_ZHit_3")->Fill(thirdHit.getPosZ(), calculateSumOfTOTs(thirdHit));
        ...
        getStatistics().getHisto1D("Angle difference 1-2 nordered")->Fill(Angle_3D_1_2_B);
        getStatistics().getHisto1D("Angle difference 2-3 nordered")->Fill(Angle_3D_2_3_B);
        getStatistics().getHisto1D("Angle difference 3-1 nordered")->Fill(Angle_3D_3_1_B);
...
void EventCategorizer::deexcitationSelection(
  ...
  if((angles[0]+angles[1]) < 175 || (angles[0]+angles[1]) > 185) {
    ...
    && thirdHitScinID != 186) {
      ...
      getStatistics().getHisto1D("Angular disp bw scatterings")->Fill(vec0.at(9));
      getStatistics().getHisto1D("Angular disp bw scatterings afterCut")->Fill(vec0.at(9));
      getStatistics().getHisto1D("2 hit assignment")->Fill(vec0.at(5));

      if(vec0.at(5) > -0.34 && vec0.at(5) < 1.38) {
        ...
        getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutDex_1")->Fill(
          calculateSumOfTOTsCalib(firstHit2, 1, 5)*pow(10, -3)
        );
        getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutDex_2")->Fill(
          calculateSumOfTOTsCalib(secondHit2, 1, 5)*pow(10, -3)
        );
        getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutDex_3")->Fill(
          calculateSumOfTOTsCalib(thirdHit2, 1, 5)*pow(10, -3)
        );
      }
    }
  }
...
void EventCategorizer::annihilationSelection(
  ...
  && thirdHitScinID != 186) {
    ...
    getStatistics().getHisto1D("Angle difference 1-2 ordered")->Fill(Angle_3D_1_2);
    getStatistics().getHisto1D("Angle difference 2-3 ordered")->Fill(Angle_3D_2_3);
    getStatistics().getHisto1D("Angle difference 3-1 ordered")->Fill(Angle_3D_3_1);
    getStatistics().getHisto2D("Angle diff bw diff hits")->Fill(Angle_3D_1_2, Angle_3D_2_3);
    getStatistics().getHisto2D("Angle diff vs time diff")->Fill(
      Angle_3D_1_2, TMath::Abs(secondHit2.getTime()-firstHit2.getTime())*pow(10,-3)
    );
    ...
    getStatistics().getHisto1D("Angular disp bw scatterings")->Fill(vec1.at(9));
    getStatistics().getHisto1D("Angular disp bw scatterings")->Fill(vec2.at(9));
    getStatistics().getHisto1D("Angular disp bw scatterings afterCut")->Fill(vec1.at(9));
    getStatistics().getHisto1D("Angular disp bw scatterings afterCut")->Fill(vec2.at(9));
    getStatistics().getHisto2D("ScintId vs Phi")->Fill(TMath::Abs(vec1.at(8)-vec1.at(7)), vec1.at(9));
    getStatistics().getHisto2D("ScintId vs Phi")->Fill(TMath::Abs(vec2.at(8)-vec2.at(7)), vec2.at(9));
    ...
    getStatistics().getHisto1D("Distance from center BCut")->Fill(vec1.at(14));

    if(TMath::Abs(vec1.at(14)>3)) return;

    getStatistics().getHisto1D("Distance from center ACut")->Fill(vec1.at(14));
    ...
    if(cutg[0]->IsInside(vec1.at(5), vec2.at(5))) {
      ...
      getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutB2B_1")->Fill(
        calculateSumOfTOTsCalib(firstHit2, 1, 5)*pow(10, -3)
      );
      getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutB2B_2")->Fill(
        calculateSumOfTOTsCalib(secondHit2, 1, 5)*pow(10, -3)
      );
      getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutB2B_3")->Fill(
        calculateSumOfTOTsCalib(thirdHit2, 1, 5)*pow(10, -3)
      );
  ...
  JPetHit primary1, JPetHit scatter, JPetHit primary2, double gamma)
{
  ...
  if(gamma == 511) getStatistics().getHisto2D("EDEP_VS_SCATTER_511")->Fill(scatterAngle, Edep);
  if(gamma == 1274.6) getStatistics().getHisto2D("EDEP_VS_SCATTER_1274")->Fill(scatterAngle, Edep);
...
void EventCategorizer::writeSelected(
  ...
  if(isScatter) {
    ...
    getStatistics().getHisto1D("TOT_Spectra_3-Hit_Cal")->Fill(
      calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3)
    );
    getStatistics().getHisto1D("TOT_Spectra_CalCutTot")->Fill(
      calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3)
    );
    ...
    if(hitZ > -5.0 && hitZ <= 5.0) {
      getStatistics().getHisto2D("TOT_EDEP_z8")->Fill(
        values.at(6),calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3)
      );
    }
    ...
    // 511 keV fill
    if(Gamma_inv == 511) {
      if(hitZ>-22.5 && hitZ<=-15.5) {
        getStatistics().getHisto1D("TOT_Z1_511")->Fill(calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3));
      }
      if(hitZ>-3.5 && hitZ<=3.5) {
        getStatistics().getHisto1D("TOT_Z2_511")->Fill(calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3));
      }
      if(hitZ>15.5 && hitZ<=22.5) {
        getStatistics().getHisto1D("TOT_Z3_511")->Fill(calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3));
      }
      getStatistics().getHisto2D("TOT_EDEP 511")->Fill(
        values.at(6),calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3)
      );
    }
    ...
    if(Gamma_inv==1274.6) {
      ...
      double primary2_TOT_val = -2332.32 + 632.038*log(primary2_eng_dep_511+606.909) - 42.0769*pow(log(primary2_eng_dep_511+606.909),2);
      ...
      getStatistics().getHisto2D("TOT_EDEP_dummy")->Fill(primary2_eng_dep_1275, primary2_TOT_val*pow(10,-3));

      if(hitZ>-22.5 && hitZ<=-15.5) {
        getStatistics().getHisto1D("TOT_Z1_1275")->Fill(calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3));
      }
      if(hitZ>-3.5  && hitZ<=3.5) {
        getStatistics().getHisto1D("TOT_Z2_1275")->Fill(calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3));
      }
      if(hitZ>15.5  && hitZ<=22.5) {
        getStatistics().getHisto1D("TOT_Z3_1275")->Fill(calculateSumOfTOTsCalib(orig,1,5)*pow(10,-3));
      }
    }
  }
}
...
void EventCategorizer::initialiseHistograms()
{
  ...
  // ANGLE DIFF B/W FIRST AND SECOND HIT
  getStatistics().createHistogram(
    new TH1F("Angle difference 1-2 ordered", "Angle difference", 360, -0.5, 359.5)
  );
  getStatistics().getHisto1D("Angle difference 1-2 ordered")->GetXaxis()->SetTitle("Angle [deg]");
  getStatistics().getHisto1D("Angle difference 1-2 ordered")->GetYaxis()->SetTitle("counts[a.u]");

  // ANGLE DIFFERENCE B/W SECOND AND THIRD HIT
  getStatistics().createHistogram(
    new TH1F("Angle difference 2-3 ordered", "Angle difference", 360, -0.5, 359.5)
  );
  getStatistics().getHisto1D("Angle difference 2-3 ordered")->GetXaxis()->SetTitle("Angle [deg]");
  getStatistics().getHisto1D("Angle difference 2-3 ordered")->GetYaxis()->SetTitle("counts[a.u]");

  // ANGLE DIFFERENCE B/W FIRST AND THIRD HIT
  getStatistics().createHistogram(
    new TH1F("Angle difference 3-1 ordered", "Angle difference", 360, -0.5, 359.5)
  );
  getStatistics().getHisto1D("Angle difference 3-1 ordered")->GetXaxis()->SetTitle("Angle [deg]");
  getStatistics().getHisto1D("Angle difference 3-1 ordered")->GetYaxis()->SetTitle("counts[a.u]");

  // ANGLE DIFFERENCES AFTER THE ORDERING OF HITS
  // ANGLE DIFF B/W FIRST AND SECOND HIT
  getStatistics().createHistogram(
    new TH1F("Angle difference 1-2 nordered", "Angle difference nordered", 360, -0.5, 359.5)
  );
  getStatistics().getHisto1D("Angle difference 1-2 nordered")->GetXaxis()->SetTitle("Angle [deg]");
  getStatistics().getHisto1D("Angle difference 1-2 nordered")->GetYaxis()->SetTitle("counts[a.u]");

  // ANGLE DIFFERENCE B/W SECOND AND THIRD HIT
  getStatistics().createHistogram(
    new TH1F("Angle difference 2-3 nordered", "Angle difference nordered", 360, -0.5, 359.5)
  );
  getStatistics().getHisto1D("Angle difference 2-3 nordered")->GetXaxis()->SetTitle("Angle [deg]");
  getStatistics().getHisto1D("Angle difference 2-3 nordered")->GetYaxis()->SetTitle("counts[a.u]");

  // ANGLE DIFFERENCE B/W FIRST AND THIRD HIT
  getStatistics().createHistogram(
    new TH1F("Angle difference 3-1 nordered", "Angle difference nordered", 360, -0.5, 359.5)
  );
  getStatistics().getHisto1D("Angle difference 3-1 nordered")->GetXaxis()->SetTitle("Angle [deg]");
  getStatistics().getHisto1D("Angle difference 3-1 nordered")->GetYaxis()->SetTitle("counts[a.u]");
  ...
  // Hit time differece 1-3
  // BACK TO BACK SELECTION WINDOW
  getStatistics().createHistogram(
    new TH2F("Angle diff vs time diff", "3-Hit conditions", 20, 170.5, 190.5, 90, -8.5, 9.5)
  );
  getStatistics().getHisto2D("Angle diff vs time diff")->GetYaxis()->SetTitle("Hit time[ps]");
  getStatistics().getHisto2D("Angle diff vs time diff")->GetXaxis()->SetTitle("Hit Angle diff[deg]");

  getStatistics().createHistogram(
    new TH2F("Angle diff bw diff hits", "3-Hit conditions", 180, -0.5, 179.5, 180, -0.5, 179.5)
  );
  getStatistics().getHisto2D("Angle diff bw diff hits")->GetYaxis()->SetTitle("Ang diff 1-3[deg]");
  getStatistics().getHisto2D("Angle diff bw diff hits")->GetXaxis()->SetTitle("Ang diff 1-2[deg]");
  ...
  // COMMON HISTOGRAMS
  // More TOT spectra - for conf
  // after selected cuts of 511
  getStatistics().createHistogram(
    new TH1F("TOT_Spectra_Cal3HitCutB2B_1", "Time over Threshold 1-4", 1500, 0.0, 150.0)
  );
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutB2B_1")->GetXaxis()->SetTitle("TOT [ns]");
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutB2B_1")->GetYaxis()->SetTitle("counts [a.u]");

  getStatistics().createHistogram(
    new TH1F("TOT_Spectra_Cal3HitCutB2B_2", "Time over Threshold 1-4", 1500, 0.0, 150.0)
  );
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutB2B_2")->GetXaxis()->SetTitle("TOT [ns]");
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutB2B_2")->GetYaxis()->SetTitle("counts [a.u]");

  getStatistics().createHistogram(
    new TH1F("TOT_Spectra_Cal3HitCutB2B_3", "Time over Threshold 1-4", 1500, 0.0, 150.0)
  );
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutB2B_3")->GetXaxis()->SetTitle("TOT [ns]");
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutB2B_3")->GetYaxis()->SetTitle("counts [a.u]");

  // After selection of cuts of 1275
  getStatistics().createHistogram(
    new TH1F("TOT_Spectra_Cal3HitCutDex_1", "Time over Threshold 1-4 ", 1500, 0.0, 150.0)
  );
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutDex_1")->GetXaxis()->SetTitle(" TOT [ns]");
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutDex_1")->GetYaxis()->SetTitle("counts [a.u]");

  getStatistics().createHistogram(
    new TH1F("TOT_Spectra_Cal3HitCutDex_2", "Time over Threshold 1-4 [ps]", 1500, 0.0, 150.0)
  );
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutDex_2")->GetXaxis()->SetTitle(" TOT 1-4 [ps]");
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutDex_2")->GetYaxis()->SetTitle("counts [a.u]");

  getStatistics().createHistogram(
    new TH1F("TOT_Spectra_Cal3HitCutDex_3", "Time over Threshold 1-4 [ps]", 1500, 0.0, 150.0)
  );
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutDex_3")->GetXaxis()->SetTitle(" TOT [ns]");
  getStatistics().getHisto1D("TOT_Spectra_Cal3HitCutDex_3")->GetYaxis()->SetTitle("counts [a.u]");

  // Total
  getStatistics().createHistogram(
    new TH1F("TOT_Spectra_CalCutTot", "Time over Threshold 1-4", 1500, 0.0, 150.0)
  );
  getStatistics().getHisto1D("TOT_Spectra_CalCutTot")->GetXaxis()->SetTitle(" TOT [ns]");
  getStatistics().getHisto1D("TOT_Spectra_CalCutTot")->GetYaxis()->SetTitle("counts [a.u]");

  // TOT sum spectra 3-hit events
  getStatistics().createHistogram(
    new TH1F("TOT_Spectra_3-Hit_Cal", "Time over Threshold 1-4", 1500, 0.0, 150.0)
  );
  getStatistics().getHisto1D("TOT_Spectra_3-Hit_Cal")->GetXaxis()->SetTitle(" TOT 1-4 [ps]");
  getStatistics().getHisto1D("TOT_Spectra_3-Hit_Cal")->GetYaxis()->SetTitle("counts [a.u]");
  ...
  getStatistics().createHistogram(
    new TH2F("TOT_EDEP_z8", "TOT vs. Energy Deposition", 3600, 0, 1200, 1500, 0, 150.)
  );
  getStatistics().getHisto2D("TOT_EDEP_z8")->GetYaxis()->SetTitle("Time over Threshold 1-4 [ns]");
  getStatistics().getHisto2D("TOT_EDEP_z8")->GetXaxis()->SetTitle("Energy Deposition [keV]");
  ...
  getStatistics().createHistogram(
    new TH2F("ScintId vs Phi", "ScintillatorID vs PhiAngle(deg)", 195, 1, 195, 380, 0.0, 380)
  );
  getStatistics().getHisto2D("ScintId vs Phi")->GetYaxis()->SetTitle("Scintillator angle(Phi)");
  getStatistics().getHisto2D("ScintId vs Phi")->GetXaxis()->SetTitle("ScintID");

  getStatistics().createHistogram(
    new TH1F("Angular disp bw scatterings", "Scattering in angular displacement", 361, 0.5, 360.5)
  );
  getStatistics().getHisto1D("Angular disp bw scatterings")->GetXaxis()->SetTitle("Azimuth b/w scatterins [deg]");
  getStatistics().getHisto1D("Angular disp bw scatterings")->GetYaxis()->SetTitle("counts [ au ]");

  getStatistics().createHistogram(
    new TH1F("Angular disp bw scatterings afterCut", "Scattering in angular displacement after cut", 361, 0.5, 360.5)
  );
  getStatistics().getHisto1D("Angular disp bw scatterings afterCut")->GetXaxis()->SetTitle("Azimuth b/w scatterins afterCut [deg]");
  getStatistics().getHisto1D("Angular disp bw scatterings afterCut")->GetYaxis()->SetTitle("counts [ au ]");
  ...
  getStatistics().createHistogram(
    new TH2F("TOT_ZHit_1", "TOT vs. Energy Deposition", 56, -28, 28, 1500, 0, 150.0)
  );
  getStatistics().getHisto2D("TOT_ZHit_1")->GetYaxis()->SetTitle("Time over Threshold [ns]");
  getStatistics().getHisto2D("TOT_ZHit_1")->GetXaxis()->SetTitle("Z Hit [cm]");

  // Added on 29 April 2018
  getStatistics().createHistogram(
    new TH2F("TOT_ZHit_2", "TOT vs. Energy Deposition", 56, -28, 28, 1500, 0, 150.0)
  );
  getStatistics().getHisto2D("TOT_ZHit_2")->GetYaxis()->SetTitle("Time over Threshold [ns]");
  getStatistics().getHisto2D("TOT_ZHit_2")->GetXaxis()->SetTitle("Z Hit [cm]");

  // Added on 29 April 2018
  getStatistics().createHistogram(
    new TH2F("TOT_ZHit_3", "TOT vs. Energy Deposition", 56, -28, 28, 1500, 0, 150.)
  );
  getStatistics().getHisto2D("TOT_ZHit_3")->GetYaxis()->SetTitle("Time over Threshold [ns]");
  getStatistics().getHisto2D("TOT_ZHit_3")->GetXaxis()->SetTitle("Z Hit [cm]");
  ...
  // -22.5 to -15.5
  getStatistics().createHistogram(
    new TH1F("TOT_Z1_511", "Time over Threshold 1-4 [ps]", 1500, 0, 150.)
  );
  getStatistics().getHisto1D("TOT_Z1_511")->GetXaxis()->SetTitle("TOT 1-4 [ps]");
  getStatistics().getHisto1D("TOT_Z1_511")->GetYaxis()->SetTitle("counts [a.u]");

  // -3.5 to 3.5
  getStatistics().createHistogram(
    new TH1F("TOT_Z2_511", "Time over Threshold 1-4 [ps]", 1500, 0, 150.)
  );
  getStatistics().getHisto1D("TOT_Z2_511")->GetXaxis()->SetTitle("TOT 1-4 [ps]");
  getStatistics().getHisto1D("TOT_Z2_511")->GetYaxis()->SetTitle("counts [a.u]");

  // 15.5 to 22.5
  getStatistics().createHistogram(
    new TH1F("TOT_Z3_511", "Time over Threshold 1-4 [ps]", 1500, 0, 150.)
  );
  getStatistics().getHisto1D("TOT_Z3_511")->GetXaxis()->SetTitle("TOT 1-4 [ps]");
  getStatistics().getHisto1D("TOT_Z3_511")->GetYaxis()->SetTitle("counts [a.u]");

  // -22.5 to -15.5
  getStatistics().createHistogram(
    new TH1F("TOT_Z1_1275", "Time over Threshold 1-4 [ps]", 1500, 0, 150.)
  );
  getStatistics().getHisto1D("TOT_Z1_1275")->GetXaxis()->SetTitle("TOT 1-4 [ps]");
  getStatistics().getHisto1D("TOT_Z1_1275")->GetYaxis()->SetTitle("counts [a.u]");

  // -3.5 to 3.5
  getStatistics().createHistogram(
    new TH1F("TOT_Z2_1275", "Time over Threshold 1-4 [ps]", 1500, 0, 150.)
  );
  getStatistics().getHisto1D("TOT_Z2_1275")->GetXaxis()->SetTitle("TOT 1-4 [ps]");
  getStatistics().getHisto1D("TOT_Z2_1275")->GetYaxis()->SetTitle("counts [a.u]");

  // 15.5 to 22.5
  getStatistics().createHistogram(
    new TH1F("TOT_Z3_1275", "Time over Threshold 1-4 [ps]", 1500, 0, 150.)
  );
  getStatistics().getHisto1D("TOT_Z3_1275")->GetXaxis()->SetTitle("TOT 1-4 [ps]");
  getStatistics().getHisto1D("TOT_Z3_1275")->GetYaxis()->SetTitle("counts [a.u]");
  ...
  getStatistics().createHistogram(
    new TH1F("Distance from center BCut", "Coordinates of annihilated point", 120,-60, 60)
  );
  getStatistics().getHisto1D("Distance from center BCut")->GetXaxis()->SetTitle("Distance [cm]");
  getStatistics().getHisto1D("Distance from center BCut")->GetYaxis()->SetTitle("counts [a.u]");

  getStatistics().createHistogram(
    new TH1F("Distance from center ACut", "Coordinates of annihilated point", 120,-60, 60)
  );
  getStatistics().getHisto1D("Distance from center ACut")->GetXaxis()->SetTitle("distance [c.m]");
  getStatistics().getHisto1D("Distance from center ACut")->GetYaxis()->SetTitle("counts [a.u]");
}
